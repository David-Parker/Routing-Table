...
queryHelper('0.0.0.0','A', 100)
queryHelper('255.255.255.254','A', 100)


# now update with a few /24 routes for B 
body = 'B 231.0.0.0/8 20\r\n'
updateHelper(body)
queryHelper('231.0.0.0','B', 20)
queryHelper('231.255.255.254','B', 20)
queryHelper('255.0.0.0','A', 100)

body = 'C 231.255.0.0/16 20\r\n'
updateHelper(body)
queryHelper('231.0.0.0','B', 20)
queryHelper('231.255.0.0','C', 20)
queryHelper('231.255.255.254','C', 20)

body = 'D 231.255.231.0/24 20\r\n'
updateHelper(body)
queryHelper('231.0.0.0','B', 20)
queryHelper('231.255.0.0','C', 20)
queryHelper('231.255.231.0','D', 20)
queryHelper('231.255.231.254','D', 20)

body = 'E 231.255.231.231/32 20\r\n'
updateHelper(body)
queryHelper('231.0.0.0','B', 20)
queryHelper('231.255.0.0','C', 20)
queryHelper('231.255.231.0','D', 20)
queryHelper('231.255.231.254','D', 20)
queryHelper('231.255.231.231','E', 20)

body = 'F 231.255.231.0/24 15\r\n'
updateHelper(body)
queryHelper('231.255.231.0','F', 15)
queryHelper('231.255.231.254','F', 15)

body = 'G 0.0.0.0/0 1\r\n'
updateHelper(body)
queryHelper('231.0.0.0','G', 1)
queryHelper('231.255.0.0','G', 1)
queryHelper('231.255.231.0','G', 1)
queryHelper('231.255.231.254','G', 1)
queryHelper('231.255.231.231','G', 1)
queryHelper('192.168.2.100','G', 1)
queryHelper('0.0.0.0','G', 1)
queryHelper('255.255.255.254','G', 1)
